...
mixin _$DownloadsState {
  ...
  List<Downloads>? get downlaods => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      isLoading: isLoading == freezed
          ...
          : isLoading // ignore: cast_nullable_to_non_nullable
              as bool,
      downlaods: downlaods == freezed
          ? _value.downlaods
          : downlaods // ignore: cast_nullable_to_non_nullable
              as List<Downloads>?,
...
class _$_DownloadsState implements _DownloadsState {
  const _$_DownloadsState(
      ...
      final List<Downloads>? downlaods,
      required this.downloadsFailureOrSuccessOption})
      : _downlaods = downlaods;

  @override
  final bool isLoading;
  final List<Downloads>? _downlaods;
  @override
  List<Downloads>? get downlaods {
    final value = _downlaods;
  ...
  @override
  String toString() {
    return 'DownloadsState(isLoading: $isLoading, downlaods: $downlaods, downloadsFailureOrSuccessOption: $downloadsFailureOrSuccessOption)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._downlaods, _downlaods) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_downlaods),
