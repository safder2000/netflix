...
abstract class $DownloadsCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: "backdrop_path") String? bannerPath});
}
...
class _$_Downloads implements _Downloads {
  const _$_Downloads(
      ...
      @JsonKey(name: "backdrop_path") required this.bannerPath});
  ...
  @override
  String toString() {
    return 'Downloads(posterPath: $posterPath, title: $title, bannerPath: $bannerPath)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.bannerPath, bannerPath));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(bannerPath));
...
abstract class _Downloads implements Downloads {
  const factory _Downloads(
          ...
          @JsonKey(name: "backdrop_path") required final String? bannerPath}) =
      _$_Downloads;
